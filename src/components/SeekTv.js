                                    ...
                                    <View style={styles.hotItem} key={index.toString() + '' + item.title}>
                                        ...
                                        <View style={{width: 80, justifyContent: 'flex-start'}}>
                                            <Text style={[styles.smallFont, {
                                                ...
                                                fontWeight: '600',
                                                color: '#000'
                                            }]}>{item.title.slice(0, 6)}{item.title.length > 6 ? '...' : ''}</Text>
                                        </View>
                                        <View style={styles.star}>
                                            <Star value={item.rating.stars}/>
                                            {item.rating.stars > 0 &&
                                            <Text style={styles.smallFont}>{(item.rating.stars / 10).toFixed(1)}</Text>}
                                        </View>
                                    </View>)
                            })}
                        </ScrollView>
                                    ...
                                    return <View key={index + '' + item.title} style={styles.renderTitle}>
                                        ...
                                        <View style={styles.rightContent}>
                                            ...
                                            <View style={{flexDirection: 'row'}}>
                                                <Star value={item.rating.stars}/>
                                                {item.rating.stars > 0 && <Text
                                                    style={styles.smallFont}>{(item.rating.stars / 10).toFixed(1)}</Text>}
                                    ...
                                    return <View key={index + '' + item.subject.title} style={styles.renderTitle}>
                                        ...
                                        <View style={styles.rightContent}>
                                            ...
                                            <View style={{flexDirection: 'row'}}>
                                                ...
                                                {item.subject.rating.stars > 0 && <Text
                                                    style={styles.smallFont}>{(item.subject.rating.stars / 10).toFixed(1)}</Text>}
