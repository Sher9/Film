            ...
            <ScrollView bounces={false} scrollEventThrottle={1}>
                {this.state.ready ? <ActivityIndicator size="large" style={{marginTop: 100}}/> :
                    <View style={{backgroundColor: '#F4F9F5'}}>
                            ...
                            <View>
                                ...
                                <View>
                                    ...
                                    <TouchableOpacity onPress={() => {
                                        ...
                                        style={{color: "#2CBA48"}}>{this.state.num != 0 && '展开'}</Text></TouchableOpacity>
                                </View>
                            </View>
                        </View>
                        ...
                        <View name="preview"
                              style={{paddingRight: 10, paddingLeft: 10, paddingTop: 15, paddingBottom: 15}}>
                            <View>
                                    ...
                                    {popular_comments.map((v, i) => {
                                        return (
                                            <View
                                                ...
                                                key={i}>
                                                <View>
                                                    <Image source={{uri: v.author.avatar}}
